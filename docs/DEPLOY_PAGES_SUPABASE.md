...
5. [Bing Webmaster Tools](https://www.bing.com/webmasters) — alimente aussi ChatGPT Search/Copilot via l'index Bing, peu de sites le font (déjà vérifié, fichier `apps/web/public/BingSiteAuth.xml`)
