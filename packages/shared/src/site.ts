...
export const missions = [
  ...
  },
  {
    ...
    mode: "Ponctuel",
    text: "PDM, dataLayer, GTM client ou server-side, Firebase. Ou migration UA vers GA4, client vers sGTM, avec recette croisée et continuité des identifiants.",
  ...
  },
  {
    ...
    mode: "Fil rouge",
    text: "Passer de scripts à des apps ou agents (Cursor, Claude) : wizard Google Ads, orchestration SEA/SEO/GEO, toujours avec un point de contrôle humain.",
